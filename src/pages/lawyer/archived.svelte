<script>
  import { lawyer_cases_archived_list } from '@/store/getStore.js'
</script>

<div class="container-fluid" style="flex:1; overflow:auto; height:100%">
  <!-- Lista predmeta -->
  <div class="row">
    {#each $lawyer_cases_archived_list.data as item}
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">
    ...
    {:else}
      <div class="col-12">
        <div style="text-align:center"><small>No items found</small></div>
      </div>
    {/each}
  </div>
</div>